import styles from '@/components/ui/form-elements/admin-page/field-code/FieldCode.module.scss'
import { IField } from '@/components/ui/form-elements/form.interface'
import clsx from 'clsx'
import { forwardRef } from 'react'

const FieldCode = forwardRef<HTMLInputElement, IField>(
...
FieldCode.displayName = 'FieldCode'
