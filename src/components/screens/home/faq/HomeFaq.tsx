...
const FAQ_ITEMS: FaqItem[] = [
	...
	},
	{
		...
		answer: (
			<span>
				бьюти-индустрии, банкам, Ecom, туроператорам, автодилерам,
	...
	{
		question: 'Могу ли я выбрать свои цвета виджета?',
		answer:
			'Да, в настройках виджета вы можете выбрать основной цвет колеса и цвет кнопки. Каждый сектор также можно настроить индивидуально.'
	},
	{
		question:
			'Если мы не оплатили вовремя, сохранятся ли наши заявки и настройки нашего виджета?',
		answer:
