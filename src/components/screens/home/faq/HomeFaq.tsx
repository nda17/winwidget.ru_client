...
const FAQ_ITEMS: FaqItem[] = [
	{
		...
		answer:
			'Виджеты помогают повысить конверсию сайта: захватывают внимание посетителя, мотивируют оставить контакт и получить скидку или бонус. Это увеличивает количество лидов без дополнительных затрат на рекламу.'
	},
	{
	...
	},
	{
		...
		answer:
			'Да, возможна полная кастомизация. В настройках виджета вы можете выбрать цвет колеса, кнопок, секторов, волчка и тд. Также каждому сектороу можно настроить процент выйгрышных выпадений.'
	},
	{
		question:
