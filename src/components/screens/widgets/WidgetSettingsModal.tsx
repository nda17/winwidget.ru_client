					...
					{tab === 'bonuses' && (
						<div className={styles.fields}>
							<p className={styles.hint}>
								...
								управляет частотой выпадения сектора: чем больше вес, тем
								чаще он выпадает. <br />
								Все веса суммируются, и каждый сектор получает долю
								пропорционально своему весу. <br />
								<br />
								Пример: колесо из 3х секторов с весами 1, 1, 8 — третий
								выпадет в 80% случаев. <br />
								<br />
								Галочка <b>«никогда не выигрывает»</b> показывает сектор на
								колесе, но исключает его из розыгрыша — вес при этом
								игнорируется.
							</p>
