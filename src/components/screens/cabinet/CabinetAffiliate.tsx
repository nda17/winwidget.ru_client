				...
				<div className={styles.affiliateHero}>
					<div>
						...
						<p className={styles.affiliateText}>
							...
							маркетологов и подрядчиков, которые рекомендуют WinWidget
							клиентам.
						</p>
					</div>
					<button
			...
			<section className={styles.section}>
				...
				<div className={styles.affiliateTerms}>
					...
					<p>
						...
						оплаты. Первые 20 суток считаются периодом охлаждения.
					</p>
					<p>
						Если платёж отменён или возвращён, право на выплату
						аннулируется.
					</p>
				</div>
			</section>
