		...
		<div className={styles.wrapper}>
			<div className={styles.hero}>
				...
				<p className={styles.lead}>
					...
					сайта, улучшать пользовательский опыт и анализировать посещаемость.
				</p>
				...
				<div className={styles.notice}>
					...
					<p className={styles.paragraph}>
						...
						настройки браузера или прекратить использование сайта. Блокировка
						всех cookie может ограничить доступ к отдельным функциям и
						разделам сайта.
					</p>
				</div>
			</div>

			<nav className={styles.contents} aria-label="Навигация по cookie policy">
			...
			<section id="general" className={styles.section}>
				...
				<p className={styles.paragraph}>
					...
					использует собственные технические и маркетинговые файлы cookie, а
					также файлы cookie партнеров (третьих лиц, установленных в
				...
				<p className={styles.paragraph}>
					...
					изменить настройки браузера: отключить или ограничить использование
					cookie и получать уведомления об их использовании.
				</p>
				<p className={styles.paragraph}>
			...
			<section id="consent" className={styles.section}>
				...
				<p className={styles.paragraph}>
					...
					, вы принимаете условия политики в отношении использования cookie,
					а также соглашаетесь с передачей полученных с помощью cookie данных
					третьим лицам и с получением маркетинговых материалов,
			...
			<section id="terms" className={styles.section}>
				...
				<p className={styles.paragraph}>
					Чтобы узнать, как используют cookie наши партнеры, ознакомьтесь
					с их политиками конфиденциальности, размещенными на их официальных
					веб-сайтах.
				</p>
				...
				<div className={styles.infoCard}>
					...
					<p className={styles.cardText}>
						...
						работу. Сервис получает данные на анонимной основе, не
						собирает сведения о личности посетителя сайта и не
						идентифицирует его как физическое лицо.
					</p>
					<p className={styles.cardText}>
